...
class GeometryWriter:
    ...
    parameters = [
        'PARAMETER squamous_apical',
        'PARAMETER squamous_basal',
        'PARAMETER squamous_lateral',
        'PARAMETER cuboidal_apical',
        'PARAMETER cuboidal_basal',
        'PARAMETER cuboidal_lateral',
        'PARAMETER columnar_apical',
        'PARAMETER columnar_basal',
        'PARAMETER columnar_lateral',
        'PARAMETER squamous_cuboidal',
        'PARAMETER cuboidal_columnar',
        'PARAMETER k_squamous_apical',
        'PARAMETER k_squamous_basal',
        'PARAMETER k_squamous_lateral',
        'PARAMETER k_cuboidal_apical',
        'PARAMETER k_cuboidal_basal',
        'PARAMETER k_cuboidal_lateral',
        'PARAMETER k_columnar_apical',
        'PARAMETER k_columnar_basal',
        'PARAMETER k_columnar_lateral',
        'PARAMETER k_squamous_cuboidal',
        'PARAMETER k_cuboidal_columnar',
        'PARAMETER l_squamous_apical',
        'PARAMETER l_squamous_basal',
        'PARAMETER l_squamous_lateral',
        'PARAMETER l_cuboidal_apical',
        'PARAMETER l_cuboidal_basal',
        'PARAMETER l_cuboidal_lateral',
        'PARAMETER l_columnar_apical',
        'PARAMETER l_columnar_basal',
        'PARAMETER l_columnar_lateral',
        'PARAMETER l_squamous_cuboidal',
        'PARAMETER l_cuboidal_columnar',
        'PARAMETER k_ecm_basal',
        'PARAMETER k_lumen_apical',
    ]
